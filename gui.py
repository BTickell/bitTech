...
img = pygame.image.load('con4.png')
r_piece = pygame.image.load('red_piece.png').convert_alpha() #image for pieces
b_piece = pygame.image.load('blue_piece.png').convert_alpha()
